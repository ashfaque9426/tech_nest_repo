    ...
    <>
      ...
      <main className='px-5 2xl:px-0' role="main" aria-labelledby="subMainContentLabel">
        ...
        <section className='pt-24' role="region" aria-labelledby="section1Label">
          ...
          <ShowMoreBtn className='text-red-500 font-semibold dark:text-white w-full' url="/showAllProductsOfSameCategory/desktop%20processor">Show More</ShowMoreBtn>
        </section>
        ...
        <section className='pt-12' role="region" aria-labelledby="section2Label">
          ...
          <ShowMoreBtn className='text-red-500 font-semibold dark:text-white w-full' url="/showAllProductsOfSameCategory/motherboard">Show More</ShowMoreBtn>
        </section>
        ...
        <section className='pt-12' role="region" aria-labelledby="section3Label">
          ...
          <ShowMoreBtn className='text-red-500 font-semibold dark:text-white w-full' url="/showAllProductsOfSameCategory/laptop">Show More</ShowMoreBtn>
        </section>
        ...
        <section className='pt-12' role="region" aria-labelledby="section4Label">
          ...
          <ShowMoreBtn className='text-red-500 font-semibold dark:text-white w-full' url="/showAllProductsOfSameCategory/smart%20phone">Show More</ShowMoreBtn>
        </section>
