            ...
            <div className="min-h-screen flex fle-col items-center justify-center py-6 px-4">
                <div className="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
                    <div className="max-md:text-center">
                        ...
                        <p className="text-sm mt-6">Immerse yourself in a hassle-free login journey with our <span className='font-bold text-red-500'>Tech Nest E-Commerce</span> Shop. Effortlessly access your account.</p>
                        <p className="text-sm mt-10">Don&#39;t have an account <Link href="/registration" className="text-blue-600 font-semibold hover:underline ml-1">Register here</Link></p>
                    </div>
                    <form onSubmit={handleLogin} className="space-y-6 max-w-md md:ml-auto max-md:mx-auto w-full">
                        ...
                        <div className='relative'>
                            <span onClick={()=> setPassVisibility(!passVisibility)} className={`${passVisibility ? 'hidden':'block'} absolute right-3 top-2 text-3xl cursor-pointer`}><MdOutlineVisibility /></span>
                            <span onClick={()=> setPassVisibility(!passVisibility)} className={`${passVisibility ? 'block' : 'hidden'} absolute right-3 top-2 text-3xl cursor-pointer`}><MdOutlineVisibilityOff /></span>
                            <input name="password" type={passVisibility ? "text" : "password"} autoComplete="current-password" required className="bg-gray-100 w-full text-sm px-4 py-3.5 rounded-md outline-blue-600" placeholder="Password" />
                        </div>
                        ...
                        <div className="!mt-10">
                            <input type="submit" className="w-full shadow-xl py-2.5 px-4 text-sm font-semibold rounded text-white bg-[#3498db] hover:bg-blue-500 focus:outline-none" value="Log in" />
                        </div>
