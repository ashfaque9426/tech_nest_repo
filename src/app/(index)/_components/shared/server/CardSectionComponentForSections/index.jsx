...
async function CardSectionComponentForSections({ title, category, brand, model, limit, limit1, limit2, className, classNameForHeading }) {
    ...
    return (
        <section className={cn('pb-12', className)}>
            ...
            {
                dataArr1?.length > 0 && <div className='mx-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:mx-auto 2xl:grid-cols-5 gap-3'>
                    {
            ...
            {
                dataArr2?.length > 0 && <div className='mx-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:mx-auto 2xl:grid-cols-5 gap-3'>
                    {
